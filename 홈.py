...
APPS = {
    ...
    "생활 도구": [
        ...
        {"icon": "⚫", "name": "바둑 입문", "desc": "튜토리얼부터 AI 대국까지 — 바둑을 처음부터 배워보세요", "page": "pages/24_⚫_바둑.py"},
        {"icon": "🔢", "name": "스도쿠 학습", "desc": "입문~중급 퍼즐 + 랜덤 생성, 힌트·자동풀기·튜토리얼 포함", "page": "pages/25_🔢_스도쿠.py"},
        {"icon": "♟", "name": "AI 체스 게임", "desc": "미니맥스 AI와 체스 대결 — 난이도 3단계, 이동 힌트 표시", "page": "pages/26_♟_체스게임.py"},
        {"icon": "🀄", "name": "AI 장기 게임", "desc": "미니맥스 AI와 한국 장기 대결 — 난이도 3단계, 차·포·마·상 정식 규칙", "page": "pages/27_🀄_장기게임.py"},
        {"icon": "🎬", "name": "영상 다운로드", "desc": "유튜브 등 대부분 사이트 영상 링크를 넣으면 파일로 저장", "page": "pages/28_🎬_영상다운로드.py"},
        {"icon": "⚔️", "name": "리니지st", "desc": "도트 캐릭터로 사냥터를 누비며 레벨업하는 나만의 미니 RPG", "page": "pages/29_⚔️_리니지st.py"},
    ],
    "재테크": [
        ...
        {"icon": "📊", "name": "주식 일일 리포트", "desc": "KOSPI·KOSDAQ·주요 종목 현황을 AI가 분석해 리포트로 정리", "page": "pages/23_📊_주식리포트.py"},
    ],
    "쇼핑 & 학습": [
        ...
        {"icon": "📦", "name": "캠핑 짐 정리 3D", "desc": "트렁크에 캠핑 장비를 3D로 배치·정리", "page": "pages/16_📦_캠핑짐정리.py"},
        {"icon": "👶", "name": "아이랑 어디갈까", "desc": "3~7세 아이와 함께 갈 여행지·놀이시설 검색 (전국 400곳)", "page": "pages/18_👶_아이랑어디갈까.py"},
        {"icon": "📰", "name": "뉴스 요약", "desc": "국내·세계 주요 뉴스를 경제/사회/스포츠/세계로 정리", "page": "pages/19_📰_뉴스요약.py"},
        {"icon": "🐟", "name": "쏘가리 낚시", "desc": "네이버 블로그에서 쏘가리 서식지·낚시 포인트 검색, 지도 표시", "page": "pages/22_🐟_쏘가리낚시.py"},
    ],
    "업무 도구": [
        {"icon": "📷", "name": "재고자산 실사", "desc": "QR 라벨 만들고, 사진 촬영으로 엑셀 자산번호 목록과 바로 대조", "page": "pages/21_📷_재고조사.py"},
    ],
}
