...
APPS = {
    ...
    "업무 도구": [
        {"icon": "🏢", "name": "자산관리", "desc": "비품·시설·소프트웨어 자산 등록, 감가상각, 엑셀 내보내기", "page": "pages/21_🏢_자산관리.py"},
    ],
    "쇼핑 & 학습": [
        ...
        {"icon": "🏷️", "name": "바코드 인식", "desc": "바코드를 스캔해서 엑셀 파일과 대조, 비고란 체크", "page": "pages/17_🏷️_바코드인식.py"},
        ...
        {"icon": "🤖", "name": "쪼니", "desc": "나만의 AI 개인비서 — 무엇이든 물어봐!", "page": "pages/20_🤖_쪼니.py"},
